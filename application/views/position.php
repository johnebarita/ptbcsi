                ...
                <table class="table table-bordered" id="dataTable">
                    ...
                    <tr class="text_center">
                        ...
                        <td class="text_center">
                            <i class="btn btn-info fa fa-edit iconedit" data-toggle="modal" data-target="#">&nbsp;&nbsp;Edit</i>&nbsp;&nbsp;&nbsp;
                            <i class="btn btn-danger fa fa-trash-alt icondelete" data-toggle="modal" data-target="#">&nbsp;&nbsp;Delete</i>
                        </td>
                    </tr>
                    <tr class="text_center">
                        <td>Programmer</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="">
                        ...
                        <div class="form-group row">
                            <label for="rph" class="col-sm-5 col-form-label">Rate per Hour</label>
                            <div class="col-sm-5">
