                ...
                <div class="row">
                    <div class="col-md-6">
                        <form action="dtr" method="post">
                            ...
                            <button type="button" class="btn btn-facebook btn-md center" data-toggle="modal" data-target="#overtimeRequest">Request Overtime</button>
                        </form>
                    </div>
                    ...
                    <div class="card-body px-lg-5 pt-0 border">
                        ...
                        <form method="post" action="">
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="formGroupExampleInput" placeholder="Please state your reason"></textarea>
                            </div>
                        </form>
                        <!-- Form -->
                    </div>
