        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="addCashAdvance" method="post" id="cash">
                        <div class="form-group row">

                            <label for="empName" class="col-sm-4 col-form-label text-right">Employee Name</label>
                            <div class="col-sm-8">
                                <select name="user_id" id="month"   class="input input-sm monthName form-control" style="width: 100%;padding: 5px">
                        ...
                        <div class="form-group row">
                            <label for="balance" class="col-sm-4 col-form-label text-right">Repayment Amount Every Payroll </label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <textarea rows="3" class="form-control" name="purpose" form="cash" placeholder="Purpose..." required></textarea>
                            </div>
                        </div>
...
<!--Modal Edit-->
    ...
    <?php foreach ($cashAdvances as $cashAdvance):?>
    <div class="modal fade" id="cashAdEdit<?=$cashAdvance->cash_advance_id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="updateCashAdvance" method="post">
                        <div class="form-group row">
                            <label for="empName" class="col-sm-4 col-form-label">Employee Name</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="empName" value="<?=strtoupper($cashAdvance->lastname." ".$cashAdvance->firstname);?>" disabled />
                                <input type="text" name="cash_id" value="<?=$cashAdvance->cash_advance_id?>" hidden/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="amount" class="col-sm-4 col-form-label">Amount</label>
                            <div class="col-sm-5">
                                <input type="number" class="form-control" name="amount"  value="<?=$cashAdvance->amount;?>"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="balance" class="col-sm-4 col-form-label">Repay Amount</label>
                            <div class="col-sm-5">
                                <input type="number" class="form-control" name="repay_amount"  value="<?=$cashAdvance->repay_amount;?>"/>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <!--    Modal for delete-->
    <div class="modal fade" id="cashAdDelete<?=$cashAdvance->cash_advance_id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
